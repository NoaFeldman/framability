...
#
#    sbatch --dependency=afterok:<array_job_id> scripts/lindbladian_trotter_collect.sh
# ============================================================
...
python scripts/lindbladian_trotter_collect.py --in_dir "$IN_DIR" --out_dir "$OUT_DIR"
