...
along the bond direction fixed by bonds_2d's nearest-neighbour ordering
...
def self_test() -> None:
    ...
    H = lattice_hamiltonian(model, 0.5, 0.9)
    ...
    assert np.allclose(flip @ H @ flip, lattice_hamiltonian(model, -0.5, -0.9), atol=1e-10)
